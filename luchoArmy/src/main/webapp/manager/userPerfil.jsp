...
<%
    ArrayList<Juego> listaJuegos = (ArrayList<Juego>) request.getAttribute("juegosDeUser");
%>
<jsp:useBean id="usuario" scope="request" type="com.games.luchito.luchoarmy.models.manager.beans.Usuario"/>
                    ...
                    <div class="card-body p-1-9 p-sm-2-3 p-md-6 p-lg-7">
                        <div class="row">
                            ...
                            <div class="col-lg-6 px-xl-10">
                                <h3 class="h2 text-bolt-black mb-3"><%=usuario.getNombre()%> <%=usuario.getApellido()%></h3>
                                <span class="h4 text-primary display-28 mb-5">Usuario</span>
                                <ul class="list-unstyled mb-1-9">
                                    <li class="mb-2 mt-3 mb-xl-3 display-28"><span class="display-22 text-secondary me-2 font-weight-600">Ultimo acceso:</span> <%=usuario.getUltimoAcceso()%></li>
                                    <li class="mb-2 mb-xl-3 display-28"><span class="display-22 text-secondary me-2 font-weight-600">Email:</span> <%=usuario.getCorreo()%></li>
                                    <li class="display-28"><span class="display-22 text-secondary me-2 font-weight-600">Celular:</span> <%=usuario.getTelefono()%></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container-fluid">
                    <div class="collapse navbar-collapse" id="2">
                        <ul class=" nav nav-pills m-auto">
                            <li class="nav-item">
                                <a class="nav-link active" href="<%=request.getContextPath()%>/AdministradoresServlet?a=inspeccionar&id=<%=usuario.getIdUsuario()%>">Detalles</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" aria-current="page" href="<%=request.getContextPath()%>/AdministradoresServlet?a=ShowadminPublicaciones&id=<%=usuario.getIdUsuario()%>">Publicaciones</a>
                            </li>
                        </ul>
                    </div>
                </div>
