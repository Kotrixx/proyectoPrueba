    ...
    <div class="pagination-container">
      <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-end">
          ...
          <li class="page-item">
            <%}%>
            <a class="page-link"  href="<%=request.getContextPath()%>/HomeServlet?act=buscar&page=<%=Integer.parseInt(str)-1%>">Anterior</a>
          </li>
          ...
          <li class="page-item"
                  <%}%>
          ><a class="page-link" href="<%=request.getContextPath()%>/HomeServlet?act=buscar&page=<%=i%>"><%=i%></a></li>
          <%}%>
          ...
          <li class="page-item ">
            <%}%>
            <a class="page-link"  href="<%=request.getContextPath()%>/HomeServlet?act=buscar&page=<%=Integer.parseInt(str)+1%>">Siguiente</a>
          </li>
