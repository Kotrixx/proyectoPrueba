        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="dropdown">
                <button class="btn mt-auto" type="button" data-bs-toggle="dropdown" aria-expanded="false" style="border: 0px " >
                    <%if(usuarioLog.getAvatar().equals("0") || usuarioLog.getAvatar().isEmpty()){%>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li style="color: darkred!important;"><a class="dropdown-item" href="<%=request.getContextPath()%>/LoginServlet?action=logout" style="color: red!important;"><b>Cerrar Sesión</b></a></li>
                </ul>
            </div>
            <!--carrito-->
            <div style="margin-right: 5px!important;"></div>
